...
class SendMailAuthVerifyJob implements ShouldQueue
{
    use Dispatchable;
    ...
    {
        $message = 'Verify Mail: ' . $this->oUser->email . "\n Token: " . $this->oUser->emailToken;
        Mail::to($this->oUser->email)->send((new VerifyAccountMail($this->oUser)));
