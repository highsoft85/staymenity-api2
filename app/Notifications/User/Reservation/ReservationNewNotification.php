...
class ReservationNewNotification extends Notification
    //implements ShouldQueue
{
    //use Queueable;

    const NAME = 'reservation-new';
    ...
    public function __construct(Reservation $oReservation)
    {
        ...
        $this->message = $oReservation->listing->title . ' - ' . $oReservation->paymentDescriptionDate;
    }
