...
class ReservationTransferNotification extends Notification
    //implements ShouldQueue
{
    //use Queueable;

    const NAME = 'reservation-transfer';
    ...
    public function __construct(Reservation $oReservation)
    {
        ...
        $this->message = 'You have a new transfer. Amount: $' . number_format($oReservation->price, 2);
    }
