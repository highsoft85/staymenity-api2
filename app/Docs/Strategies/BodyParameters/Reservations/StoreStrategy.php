...
namespace App\Docs\Strategies\BodyParameters\Reservations;
...
class StoreStrategy extends Strategy
{
    ...
    public function data()
    {
        return [
            ...
            'first_name' => $this->parameterFirstName(),
            'last_name' => $this->parameterLastName(),
            'phone' => $this->parameterPhone(),
            'phone_verified' => $this->parameterPhoneVerified(),
            'email' => $this->parameterEmail(),
            'password' => $this->parameterPassword(),
        ];
    }
}
