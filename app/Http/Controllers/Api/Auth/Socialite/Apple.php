...
class Apple extends AuthController
{
     ...
     */
    public function __invoke(SocialiteRequest $request, AppleAccountService $service)
    {
        ...
        slackInfo(AppleAccountService::NAME);
        ...
        $oUser = $service->createOrGetUser(Socialite::with(AppleAccountService::NAME)->userFromToken($token), $oUser);
        if (is_null($oUser)) {
