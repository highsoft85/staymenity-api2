...
return [
    ...
    /**
     * Для замены телефона, например я хочу чтобы отправлялось на мой номер какой-то другой
     */
    'replace_number' => [
        'enabled' => env('NEXMO_REPLACE_NUMBER_ENABLED', false),
        'from' => env('NEXMO_REPLACE_NUMBER_FROM', null),
        'to' => env('NEXMO_REPLACE_NUMBER_TO', null),
    ],

    'enabled' => function_exists('env') ? env('NEXMO_ENABLED', false) : false,
    ...
    */
    ...
    // For send use config.services.nexmo.from
    'from' => function_exists('env') ? env('NEXMO_FROM', 'Staymenity') : 'Staymenity',
];
